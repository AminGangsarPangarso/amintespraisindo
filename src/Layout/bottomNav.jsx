...
const Navbar = () => {
    return ( 
        <>
        <div className="bg-purple-400 h-72 ">
        <header className="bg-blue-500 text-white text-center py-4 container">
      <div className="flex w-full ">
      <ul className="flex justify-end w-full px-10 gap-6 text-2xl ">
        <li><BsSearch/></li> 
        <li><AiOutlineStar/></li> 
...
<nav className="bg-gray-800 text-white text-center py-2 bottom-0 left-0 fixed w-full">
<ul className="flex justify-center space-x-4">
  <li className="px-4">
    <AiOutlineHome className="text-center w-full text-lg"/>
    <Link to='/beranda'> Home</Link>
  </li>
  <li className="px-4">
    <BiLeaf className="text-center w-full text-lg"/> 
    <Link> Product</Link>
  </li>

<div className="">
<div data-dial-init className="  group bg-">
  ...
  <li className="px-4">
    <BiTransfer  className="text-center w-full text-lg"/>
    <Link> Transaction</Link>
  </li>
  <li className="px-4">
    <SiJamstack  className="text-center w-full text-lg"/>
    <Link> Portflio</Link>
  </li>
</ul>
</nav>
